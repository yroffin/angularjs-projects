...
angular.module('myApp.controllers', [])
  ...
  .controller('MyCtrl1', ['$rootScope','$http', 'GoogleAppsService', function($scope, $http, GoogleAppsService) {
    /**
     * load swap
     */
    $scope.test = function() {
        if($scope.googleDrive) return;
        GoogleAppsService.getRootFolder({message: {}},
        function(data) {
    ...
    $scope.load = function(folder) {
        ...
        GoogleAppsService.getChildren({message: {folder: folder}},
        function(data) {
            console.log(data);
    ...
    $scope.show = function(folder) {
         ...
         * show content
         */
        GoogleAppsService.getFiles({message: {folder: folder}},
        function(data) {
            console.log(data);
    ...
    $scope.load = function() {
         ...
         */
        console.log("load");
        GoogleAppsService.getDocumentAsText({message: {id: '1TfvtWZtyYI6idTvkOw34-_quXwgk_Ee4Kv8K-p_al4I'}},
        function(data) {
  ...
  .controller('MyCtrl2', ['$rootScope', '$http', 'GoogleAppsService', function($scope, $http, GoogleAppsService) {
    /**
     * load swap
     */
    $scope.svg = function() {
